    ...
    <main className="mx-auto max-w-3xl px-6 py-16 sm:py-20">
      ...
      {GEO_RESOLVED > 0 && (
        <Section title="Where claims come from">
          <ClaimMap points={Object.values(CLAIM_GEO)} total={GEO_TOTAL} />
          <p className="text-xs leading-relaxed text-(--color-muted)">
            {GEO_RESOLVED} of {GEO_TOTAL} owners resolved: coordinates come from the public
            location field on their GitHub profiles and from the country captured at claim time
            (regenerated by scripts/geocode-owners.mjs). Blank or unplaceable locations count
            toward nothing, and everything here is approximate.
          </p>
        </Section>
      )}
