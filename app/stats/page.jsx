...
import { DotMap, continentOf } from '../components/ui.jsx';
        ...
        <Section title="Where claims come from">
          ...
          <RowList>
            {Object.values(CLAIM_GEO)
              ...
              .map((c) => (
                <li key={c.name} className="flex items-baseline justify-between px-5 py-3.5">
                  <span className="text-sm text-(--color-ash)">{c.name}</span>
          ...
          <p className="text-xs leading-relaxed text-(--color-muted)">
            Resolved from the public location field on {GEO_RESOLVED} of {GEO_TOTAL} owners&rsquo;
            GitHub profiles (regenerated by scripts/geocode-owners.mjs). Blank or unplaceable
